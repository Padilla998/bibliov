...
<head>
	...
	<title>SVM - <?php echo $title; ?></title>
...
<div class="wrapper">
	...
	<header class="main-header">
		...
		<a href="<?php echo base_url(); ?>backend/dashboard" class="logo">
			...
			<span class="logo-lg"><b>SVM</b></span>
		</a>
	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="<?php echo $this->uri->segment(2) === "categorias" ? 'active' : '' ?> treeview">
					<a href="<?php echo base_url(); ?>backend/categorias">
