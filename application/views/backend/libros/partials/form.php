...
<div class="col-md-6">
    ...
    <div class="form-group">
        <label for="ediccion">Edicion</label>
        <?php if (isset($libro->ediccion_libro)): ?>
            <input type="text" class="form-control" id="ediccion" name="ediccion" placeholder="Edicion" value="<?php echo $libro->ediccion_libro; ?>">
        <?php else: ?>
            <input type="text" class="form-control" id="ediccion" name="ediccion" placeholder="Edicion">
        <?php endif;?>
    </div>
    <div class="form-group">
    ...
    <div class="form-group <?php echo form_error('idfacultad') == true ? 'has-error' : '' ?>">
        <label for="idfacultad" class="control-label">Categoria</label>
