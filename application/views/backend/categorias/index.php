        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-12 text-right">
                    <a href="<?php echo base_url(); ?>backend/categorias/add" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Nueva Categoria</a>
                </div>
            </div>
            <!-- /.row -->
             <hr>
                ...
                <div class="col-md-12">
                    <table id="example1" class="table table-bordered table-dataTables">
                        ...
                        <tbody>
                            <?php if ($categorias): ?>
                                <?php $i = 1;?>
                                <?php foreach ($categorias as $facultad): ?>
                                    <tr>
                                        <td><?php echo $i ?></td>
