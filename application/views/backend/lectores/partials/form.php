...
<div class="col-md-6">
    ...
    <div class="form-group <?php echo form_error('dui') == true ? 'has-error' : '' ?>">
        <label for="dui">DUI</label>
        <?php if (isset($lector->dui)): ?>
            <?php $valor = form_error('dui') == true ? set_value('dui') : $lector->dui;?>;
            <input type="text" class="form-control" id="dui" name="dui" placeholder="dui" value="<?php echo $valor; ?>">
        <?php else: ?>
            <input type="text" class="form-control" id="dui" name="dui" placeholder="dui" value="<?php echo set_value('dui'); ?>">
        <?php endif;?>
        <?php echo form_error('dui'); ?>
    </div>
</div>
<div class="col-md-6">
