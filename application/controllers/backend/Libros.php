...
class Libros extends CI_Controller
{
    ...
    public function add()
    {
        ...
        $contenido_interno = array(
            'facultades' => $this->Categorias_model->getCategorias(),
        );
    ...
    public function store()
    {
        ...
        $id_categoria  = $this->input->post("idfacultad");
        ...
        $this->form_validation->set_rules('idfacultad', 'Categoria', 'trim|required', array('required' => 'Debes proporcionar un %s.'));
